...
def showSkeletons():
    ...
    global weapon
    print("You see a wall of skeletons as you walk into the room. There is a pair of eyes watching you. Where would you like to go?")
    userInput = ""
    while userInput not in directions:
